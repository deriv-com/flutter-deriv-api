...
import 'package:flutter_deriv_api/models/contarcts/contarcts_for/contracts_for.dart';
...
void main() {
  test('Contracts for json parsing', () async {
    ...
    expect(contractsFor.available.first.forwardStartingOptions.first.close, 1586303999);
    expect(contractsFor.available.first.forwardStartingOptions.last.open, 1586390400);
