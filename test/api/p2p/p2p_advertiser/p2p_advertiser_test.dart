...
import 'package:flutter_deriv_api/api/response/p2p_advertiser_info_receive_result.dart';
import 'package:flutter_deriv_api/api/response/p2p_advertiser_create_receive_result.dart';
import 'package:flutter_deriv_api/api/response/p2p_advertiser_update_receive_result.dart';
import 'package:flutter_deriv_api/api/response/p2p_advertiser_adverts_receive_result.dart';
...
void main() {
  ...
  group('P2P Advertiser Group ->', () {
    test('Fetch Advertiser Information Test', () async {
      ...
      final P2pAdvertiserInfo advertiser = advertiserResponse.p2pAdvertiserInfo;
    ...
    test('Subscribe to Advertiser Test', () {
      P2pAdvertiserInfoResponse.subscribeAdvertiserInformation(
        ...
        expectAsync1((P2pAdvertiserInfoResponse advertiser) {
          ...
          expect(advertiser.p2pAdvertiserInfo.chatUserId, 'p2p_CR_1589256468');
          expect(
              advertiser.p2pAdvertiserInfo.contactInfo, 'contract information');
          ...
          expect(
              advertiser.p2pAdvertiserInfo.paymentInfo, 'payment information');
    ...
    test('Create Advertiser Test', () async {
      ...
      expect(advertiser.p2pAdvertiserCreate.paymentInfo, 'payment information');
    });
    ...
    test('Update Advertiser Test', () async {
      ...
      expect(advertiser.p2pAdvertiserUpdate.paymentInfo, 'payment information');
    });
    ...
    test('Fetch Advertiser Adverts Test', () async {
      ...
      expect(adverts.first.paymentMethod, PaymentMethodEnum.bankTransfer);
