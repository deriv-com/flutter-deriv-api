...
void main() {
  ...
  test('Fetch Portfolio Test', () async {
    ...
    expect(portfolio.portfolio?.contracts.first.purchaseTime,
        getDateTime(1587634074));
    expect(portfolio.portfolio?.contracts.first.expiryTime,
        getDateTime(1587761700));
    expect(portfolio.portfolio?.contracts.first.expiryTime,
        getDateTime(1587761700));
