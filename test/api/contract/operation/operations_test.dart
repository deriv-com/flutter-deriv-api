...
import 'package:flutter_deriv_api/api/response/contract_update_history_receive_result.dart';
...
void main() {
  ...
  group('Contract Operations Group ->', () {
    ...
    test('Buy Contract Test', () async {
      ...
      expect(
          openContract.proposalOpenContract.dateStart, getDateTime(1587533920));
      ...
      expect(
          openContract.proposalOpenContract.auditDetails.contractEnd.first.tick,
          1419.96);
      expect(
        openContract.proposalOpenContract.auditDetails.contractEnd.first.epoch,
