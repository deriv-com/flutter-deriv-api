...
abstract class GetSettingsModel {
  ...
  const GetSettingsModel({
    ...
    this.tinSkipped,
    this.tncStatus,
    this.tncUpdateNotificationStartDate,
    this.tradingHub,
    this.userHash,
  });
  ...
  final String? tncUpdateNotificationStartDate;
...
class GetSettings extends GetSettingsModel {
  ...
  const GetSettings({
    ...
    super.tinSkipped,
    super.tncStatus,
    super.tncUpdateNotificationStartDate,
    super.tradingHub,
    super.userHash,
  });
  ...
  factory GetSettings.fromJson(Map<String, dynamic> json) => GetSettings(
        ...
        tncUpdateNotificationStartDate:
            json['tnc_update_notification_start_date'],
  ...
  Map<String, dynamic> toJson() {
    ...
    resultMap['tnc_update_notification_start_date'] =
        tncUpdateNotificationStartDate;
  ...
  GetSettings copyWith({
    ...
    String? tncUpdateNotificationStartDate,
    int? tradingHub,
    String? userHash,
  }) =>
      GetSettings(
        ...
        tncUpdateNotificationStartDate: tncUpdateNotificationStartDate ??
            this.tncUpdateNotificationStartDate,
