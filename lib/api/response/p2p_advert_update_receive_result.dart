...
import '../../basic_api/generated/p2p_advert_update_receive.dart';
...
abstract class P2pAdvertUpdateModel {
  ...
  final P2pAdvertUpdateAdvertiserDetails advertiserDetails;
...
class P2pAdvertUpdate extends P2pAdvertUpdateModel {
  ...
  P2pAdvertUpdate({
    ...
    @required P2pAdvertUpdateAdvertiserDetails advertiserDetails,
  ...
  factory P2pAdvertUpdate.fromJson(Map<String, dynamic> json) =>
      P2pAdvertUpdate(
        ...
        advertiserDetails: json['advertiser_details'] == null
            ? null
            : P2pAdvertUpdateAdvertiserDetails.fromJson(
  ...
  P2pAdvertUpdate copyWith({
    ...
    P2pAdvertUpdateAdvertiserDetails advertiserDetails,
    double amount,
...
/// P2p advert update advertiser details model class
abstract class P2pAdvertUpdateAdvertiserDetailsModel {
  /// Initializes
  P2pAdvertUpdateAdvertiserDetailsModel({
    @required this.name,
...
/// P2p advert update advertiser details class
class P2pAdvertUpdateAdvertiserDetails
    extends P2pAdvertUpdateAdvertiserDetailsModel {
  /// Initializes
  P2pAdvertUpdateAdvertiserDetails({
  ...
  /// Creates an instance from JSON
  factory P2pAdvertUpdateAdvertiserDetails.fromJson(
  ...
  /// Creates a copy of instance with given parameters
  P2pAdvertUpdateAdvertiserDetails copyWith({
    String firstName,
    String id,
    String lastName,
    String name,
