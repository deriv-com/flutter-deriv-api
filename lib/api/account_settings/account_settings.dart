...
class AccountSettings extends AccountSettingsModel {
  ...
  AccountSettings({
    ...
    String firstName,
    int hasSecretAnswer,
    int isAuthenticatedPaymentAgent,
    String lastName,
    String phone,
    String placeOfBirth,
  ...
  factory AccountSettings.fromJson(Map<String, dynamic> json) =>
      AccountSettings(
        ...
        allowCopiers: json['allow_copiers'],
        ...
        hasSecretAnswer: json['has_secret_answer'],
        isAuthenticatedPaymentAgent: json['is_authenticated_payment_agent'],
