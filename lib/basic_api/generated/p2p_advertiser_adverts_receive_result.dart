/// P2p advertiser adverts receive model class
abstract class P2pAdvertiserAdvertsReceiveModel {
  /// Initializes
  P2pAdvertiserAdvertsReceiveModel({
...
class P2pAdvertiserAdvertsReceive extends P2pAdvertiserAdvertsReceiveModel {
  /// Initializes
  ...
  factory P2pAdvertiserAdvertsReceive.fromJson(Map<String, dynamic> json) =>
      P2pAdvertiserAdvertsReceive(
        p2pAdvertiserAdverts: json['p2p_advertiser_adverts'] == null
            ? null
            : P2pAdvertiserAdverts.fromJson(json['p2p_advertiser_adverts']),
      );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pAdvertiserAdverts != null) {
      result['p2p_advertiser_adverts'] = p2pAdvertiserAdverts.toJson();
    }
