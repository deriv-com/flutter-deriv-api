...
import '../../api/exceptions/asset_index_exception.dart';
...
class AssetIndexResponse extends AssetIndexResponseModel {
  ...
  static Future<List<AssetIndexResponse>> fetchAssetIndices([
    ...
    return getListFromMap(
      response.assetIndex,
      itemToTypeCallback: (dynamic item) => AssetIndexResponse.fromJson(item),
    );
  }
