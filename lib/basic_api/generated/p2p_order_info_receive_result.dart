/// P2p order info receive model class
abstract class P2pOrderInfoReceiveModel {
  /// Initializes
  P2pOrderInfoReceiveModel({
...
class P2pOrderInfoReceive extends P2pOrderInfoReceiveModel {
  /// Initializes
  P2pOrderInfoReceive({
  ...
  factory P2pOrderInfoReceive.fromJson(Map<String, dynamic> json) =>
      P2pOrderInfoReceive(
        p2pOrderInfo: json['p2p_order_info'] == null
            ? null
            : P2pOrderInfo.fromJson(json['p2p_order_info']),
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pOrderInfo != null) {
      result['p2p_order_info'] = p2pOrderInfo.toJson();
    }
