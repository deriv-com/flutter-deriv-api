/// P2p advert info receive model class
abstract class P2pAdvertInfoReceiveModel {
  /// Initializes
  P2pAdvertInfoReceiveModel({
...
class P2pAdvertInfoReceive extends P2pAdvertInfoReceiveModel {
  /// Initializes
  ...
  factory P2pAdvertInfoReceive.fromJson(Map<String, dynamic> json) =>
      P2pAdvertInfoReceive(
        p2pAdvertInfo: json['p2p_advert_info'] == null
            ? null
            : P2pAdvertInfo.fromJson(json['p2p_advert_info']),
      );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pAdvertInfo != null) {
      result['p2p_advert_info'] = p2pAdvertInfo.toJson();
    }
...
class P2pAdvertInfo extends P2pAdvertInfoModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    result['max_order_amount_limit'] = maxOrderAmountLimit;
    result['max_order_amount_limit_display'] = maxOrderAmountLimitDisplay;
    result['min_order_amount'] = minOrderAmount;
    result['min_order_amount_display'] = minOrderAmountDisplay;
    result['min_order_amount_limit'] = minOrderAmountLimit;
    result['min_order_amount_limit_display'] = minOrderAmountLimitDisplay;
