/// P2p advert list receive model class
abstract class P2pAdvertListReceiveModel {
  /// Initializes
  P2pAdvertListReceiveModel({
...
class P2pAdvertListReceive extends P2pAdvertListReceiveModel {
  /// Initializes
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pAdvertList != null) {
      result['p2p_advert_list'] = p2pAdvertList.toJson();
    }
