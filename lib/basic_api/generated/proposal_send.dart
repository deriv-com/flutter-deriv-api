...
class ProposalRequest extends Request {
  ...
  ProposalRequest copyWith({
    ...
    Map<String, dynamic>? passthrough,
    int? reqId,
    bool resetMultiplier = false,
    bool resetLimitOrder = false,
    bool resetCancellation = false,
    bool resetBarrier = false,
    bool resetDuration = false,
  }) =>
      ProposalRequest(
        amount: amount ?? this.amount,
        barrier: resetBarrier ? null : barrier ?? this.barrier,
        barrier2: barrier2 ?? this.barrier2,
        basis: basis ?? this.basis,
        cancellation:
            resetCancellation ? null : cancellation ?? this.cancellation,
        ...
        limitOrder: resetLimitOrder ? null : limitOrder ?? this.limitOrder,
        multiplier: resetMultiplier ? null : multiplier ?? this.multiplier,
