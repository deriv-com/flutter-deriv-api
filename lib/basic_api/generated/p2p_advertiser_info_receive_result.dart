/// P2p advertiser info receive model class
abstract class P2pAdvertiserInfoReceiveModel {
  /// Initializes
  P2pAdvertiserInfoReceiveModel({
...
class P2pAdvertiserInfoReceive extends P2pAdvertiserInfoReceiveModel {
  /// Initializes
  ...
  factory P2pAdvertiserInfoReceive.fromJson(Map<String, dynamic> json) =>
      P2pAdvertiserInfoReceive(
        p2pAdvertiserInfo: json['p2p_advertiser_info'] == null
            ? null
            : P2pAdvertiserInfo.fromJson(json['p2p_advertiser_info']),
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pAdvertiserInfo != null) {
      result['p2p_advertiser_info'] = p2pAdvertiserInfo.toJson();
    }
