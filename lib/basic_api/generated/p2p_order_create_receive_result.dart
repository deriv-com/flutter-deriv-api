/// P2p order create receive model class
abstract class P2pOrderCreateReceiveModel {
  /// Initializes
  P2pOrderCreateReceiveModel({
...
class P2pOrderCreateReceive extends P2pOrderCreateReceiveModel {
  /// Initializes
  ...
  factory P2pOrderCreateReceive.fromJson(Map<String, dynamic> json) =>
      P2pOrderCreateReceive(
        p2pOrderCreate: json['p2p_order_create'] == null
            ? null
            : P2pOrderCreate.fromJson(json['p2p_order_create']),
  ...
  Map<String, dynamic> toJson() {
    ...
    if (p2pOrderCreate != null) {
      result['p2p_order_create'] = p2pOrderCreate.toJson();
    }
